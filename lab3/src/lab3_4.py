...
c_layer1 = mx.sym.Convolution(data=data, kernel=(7,7), num_filter=5, stride=(4,4))
...
c_layer2 = mx.sym.Convolution(data=c_layer1_pool, kernel=(5,5), num_filter=5, stride=(2,2))
