...
c_layer1 = mx.sym.Convolution(data=data, kernel=(7,7), num_filter=50, stride=(4,4))
...
c_layer3 = mx.sym.Convolution(data=c_layer2_pool, kernel=(3,3), num_filter=50, stride=(1,1))
c_layer3_act = mx.sym.Activation(data=c_layer3, act_type="tanh")
c_layer3_pool = mx.sym.Pooling(data=c_layer3_act, pool_type="max", kernel=(2,2), stride=(1,1))

fc_input = mx.sym.flatten(data = c_layer3_pool)
